...
//Invariant: els objectes de la classe Data sempre contenen una data vàlida.
    ...
    private:
        ...
        static bool es_data_valida(int any, int mes, int dia);
        //Pre: cert
    ...
    public:
        ...
        Data(int any, int mes, int dia); //Constructor amb paràmetres
        //Pre: cert
        //Post: *this representa la data dia/mes/any si aquesta és vàlida
        //      altrament representa la data 1/1/2000
        Data(int any, string mes, int dia); //Constructor amb paràmetres
        //Pre: cert
        //Post: *this representa la data dia/mes/any si aquesta és vàlida
...
//--------Mètodes consultors---------
        ...
        //-----------------Mètodes de classe-----------------
        static void escriure_calendari(int any, int mes);
        ...
        static int dies_mes(int any, int mes);
        //Pre: mes>=1 i mes<=12 i any>=ANY_INICI_CALENDARI
